...
### These are the l values for problem 3
#l = [3,11,24]
### These are the l values for problem 3
l = [32]
### Do the verifications first
#i=np.linspace(-1,1,100)
#count = 0
#for j in i:
#    count = Verify(12,j, count)
#if count == 1000:
#    print "Passes All Checks"
### Input the Polynomial parameters here
### The first digit is the order, the second is the x value
...
for k in l:
    t = FindZeros(k)
#    print "Here are the Zeros for N=" + str(k)
#    print str(t) + '\n'
z =[]
summ=0
for i in range(0,l[0]):
    ...
    summ = z[i] + summ
#print "Here are the Weights for N=" + str(k)
#print z
...
#        Q[0,i] = S[0,i] + 0.5*SigmaS1[1]*phi[i]
